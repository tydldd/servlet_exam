var resProtocol = location.protocol.substr(0, 4) === 'http' ? '' : 'http:';
document.writeln("<link rel=\"stylesheet\" type=\"text\/css\" href=\"" + resProtocol + "//csdnimg.cn/pubnav/css/navtop_2012.css\" \/>");
...
function showNavMore(e) {
    ...
    ss += '<link type="text/css" rel="Stylesheet" href="' + resProtocol + '//csdnimg.cn/pubnav/css/navtop_2012.css" />';
    ...
    var arr2 = ['club.csdn.net/cto', 'student.csdn.net', 'edu.csdn.net', 'programmer.csdn.net', 'www.iteye.com', 'tup.csdn.net'];
...
if (p__un) {
   (function() {
       ...
       ca.src = resProtocol + '//my.csdn.net/index.php/service/notifications/getnl?jsonpcallback=csdnShowSpaceNotify';
